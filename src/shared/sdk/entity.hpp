...
namespace offsets::entity {
    ...
    constexpr uintptr_t m_iCrosshairId = 0x1B20; // int  — entity index in crosshair (0 = none)

    // --- Movement / position ---
    constexpr uintptr_t m_vecOrigin   = 0x0320; // Vec3  — world-space feet position
    constexpr uintptr_t m_vecVelocity = 0x0330; // Vec3  — current velocity [UNVERIFIED]
    ...
    // --- Flash ---
    constexpr uintptr_t m_flFlashMaxAlpha    = 0x1A54; // float — write 0.f to remove flash
    constexpr uintptr_t m_flFlashDuration    = 0x1A4C; // float — write 0.f to remove flash
